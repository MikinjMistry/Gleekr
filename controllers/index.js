 ...
 * @apiSuccess (Success 200) {String} refreshToken Unique refreshToken which needs to be passed to generate new access token if the current one expires
 * @apiError (Error 4xx) {String} message Validation or error message
 */
...
/**
 * @api {post} /refresh_token Refresh Token - READY
 * @apiName Refresh token
 * @apiGroup Root
 * 
 * @apiHeader {String}  refreshToken  Existing refreshToken
 * 
 * @apiSuccess (Success 200) {String} message Success message.
 * @apiSuccess (Success 200) {String} token Unique token which needs to be passed in subsequent requests
 * @apiSuccess (Success 200) {String} refreshToken Unique refreshToken which needs to be passed to generate new access token if the current one expires
