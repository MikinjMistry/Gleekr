define({ "api": [
  {
    ...
    "title": "Add/update activity action",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "isPublic",
            "description": "<p>form-data: Mark activity as private or public</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "members",
            "description": "<p>array of userid to add as member</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>form-data: group name</p>"
          },
          {
            "group": "Parameter",
            "type": "file",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>form-data: group id that is going to update</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "title": "BOT TimeLine",
    "name": "BOT_TimeLine",
    "description": "<p>Example: /user/actions?start=[START INDEX]&amp;offset=[LIMIT]</p>",
    "group": "User___READY",
    "header": {
      "fields": {
        "Header": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "start",
            "description": "<p>Start index starting from 0</p>"
          },
          {
            "group": "Parameter",
            "type": "number",
            "optional": false,
            "field": "offset",
            "description": "<p>Offset indicates the number of records which needs to be fetch each time</p>"
          }
        ]
      }
    },
